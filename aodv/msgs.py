...
@dataclass
class RREQ_Head(GenericMessageHeader):
...
@dataclass
class RREQ_Data(GenericMessagePayload):
    """**Route Request (RREQ) Message Header Format**"""
...
@dataclass
class RREP_Head(GenericMessageHeader):
...
@dataclass
class RREP_Data(GenericMessagePayload):
...
@dataclass
class RERR_Head(GenericMessageHeader):
...
@dataclass
class RERR_Data(GenericMessagePayload):
...
@dataclass
class RERR_Ack(GenericMessageHeader):
